...
func _build_level() -> void:
	...
	add_entity(MOVING_PLATFORM_SCENE, Vector2(400, 155), {"offset": Vector2(72, 0), "travel_time": 1.8})
	add_entity(MOVING_PLATFORM_SCENE, Vector2(1090, 150), {"offset": Vector2(95, -28), "travel_time": 2.4})
